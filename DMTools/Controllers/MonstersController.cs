...
namespace DMTools.Controllers
{
    public class MonstersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Health,ArmorClass,Speed,ChallengeRating,IsLegendary,Strength,Dexterity,Constitution,Intelligence,Wisdom,Charisma,Size,Race,Type,Species,Alignment,SavingThrows,Skills,Senses")] Monster monster)
        {
